...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "We installed the WooCommerce plugin in an afternoon and started seeing agent traffic the same week. The HTTP 402 flow just works — no CAPTCHA, no chargebacks.",
      name: "Jamie Marshall",
      company: "Head of Commerce, Northwind Goods",
      image: "/testimonial-avatar-1.jpg",
    },
    {
      quote:
        "Our agents pay from whatever chain they hold liquidity on, and we always receive clean USDC. CogentaPay abstracted away the hardest part of machine commerce.",
      name: "Sarah Chen",
      company: "Founder, Autobuy AI",
      image: "/testimonial-avatar-2.jpg",
    },
    {
      quote:
        "The cryptographic receipts settled every dispute for us. Both sides hold provable, on-chain proof of settlement — reconciliation went from days to seconds.",
      name: "Marcus Rodriguez",
      company: "CTO, LedgerLoop",
