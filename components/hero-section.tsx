          ...
          <div className="max-w-[937px] flex flex-col items-center gap-3">
            <div className="flex flex-col items-center gap-6">
              <h1 className="max-w-[748px] text-center text-[#37322f] text-5xl md:text-[80px] font-normal leading-tight md:leading-[96px] font-serif">
                Checkout built for AI agents, not humans
              </h1>
              <p className="max-w-[540px] text-center text-[#37322f]/80 text-lg font-medium leading-7">
                CogentaPay lets autonomous agents pay you directly — by card, by crypto, or over x402. One
                integration, zero CAPTCHAs, instant settlement.
              </p>
            </div>
          </div>
